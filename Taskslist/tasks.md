...
- [x] 1. Project Setup and Configuration
  - [x] 1.1 Initialize Next.js 14 project with App Router, TypeScript, TailwindCSS, and ESLint
  ...
  - [x] 1.2 Install and configure Shadcn/UI with mobile-optimized theme
    - Run `npx shadcn-ui@latest init`
    - Install required components: Button, Card, Input, Select, Form, Dialog, Toast, Avatar
    - _Requirements: 8.1_
  - [x] 1.3 Set up Supabase client and environment variables
...
- [x] 7. Financial Calculation Utilities
  ...
  - [x] 7.2 Write property test for net margin calculation
    - **Property 2: Net Margin Calculation**
    - **Validates: Requirements 4.2, 4.3**
  - [x] 7.3 Implement profit calculation functions
  ...
  - [x] 7.4 Write property test for profit calculation
    - **Property 6: Profit Calculation**
    - **Validates: Requirements 6.3, 6.6**
  - [x] 7.5 Write property test for partner payout calculation
    - **Property 7: Partner Payout Calculation**
    - **Validates: Requirements 6.7, 6.8**
  - [x] 7.6 Implement ROI and return rate calculations
    - Create `calculateROI(profit, totalCapital)`
    - Create `calculateReturnRate(returnedOrders, totalOrders)`
    - _Requirements: 6.4, 6.5_
  - [x] 7.7 Write property test for ROI calculation
    - **Property 8: ROI Calculation**
    - **Validates: Requirements 6.4**
  - [x] 7.8 Write property test for return rate calculation
    - **Property 9: Return Rate Calculation**
    - **Validates: Requirements 6.5**

- [x] 8. Transaction Management
  - [x] 8.1 Create transaction service with CRUD operations
